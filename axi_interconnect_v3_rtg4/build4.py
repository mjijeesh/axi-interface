...
def main():
    ...
    helper_epilog = (
        ...
        "  # 2. Run simulation interactively inside ModelSim GUI\n"
        "  python3 build.py --family rtg4 --sim --tb_top tb_top_axi --gui\n\n"
        "  # 3. Launch simulation inside terminal interactive console shell\n"
    ...
    # SPEED OPTIMIZATION: For interactive setups, force Libero's headless phase 
    # to run for 0ns so it exits instantly after compiling everything and writing run.do
