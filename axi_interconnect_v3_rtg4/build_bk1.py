...
# ==========================================================================
def generate_tcl(target, hdl_dir, stim_dir, constraints, output_tcl, mode, tcl_dir=None, design_tcls=None):
...
def main():
    ...
    generate_tcl(target, hdl_dir, stim_dir, constraints, output_tcl, mode, tcl_dir_active, design_tcls_active)
